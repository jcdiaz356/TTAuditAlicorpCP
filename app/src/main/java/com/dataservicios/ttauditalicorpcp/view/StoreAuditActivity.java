...
import com.dataservicios.ttauditalicorpcp.model.RouteStoreTime;
...
import com.dataservicios.ttauditalicorpcp.repo.RouteStoreTimeRepo;
            ...
            buttonArray[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(audit_id == 1) {
                        ...
                        PublicityStoreRepo publicityStoreRepo = new PublicityStoreRepo(activity);
                        ArrayList<PublicityStore> publicityStores = (ArrayList<PublicityStore>) publicityStoreRepo.findAll();

                        for (PublicityStore p : publicityStores) {
                            p.setActive(0);
                            publicityStoreRepo.update(p);
                        }
...
//                        }
                        ...
                        bundle.putInt("category_product_id", 54);
...
//                        }
                        ...
                        bundle.putInt("store_id", Integer.valueOf(store_id));
                        bundle.putInt("audit_id", Integer.valueOf(audit_id));
                        bundle.putInt("category_product_id", 53);
                        Intent intent = new Intent(activity, PublicitiesActivity.class);
//                        Intent intent = new Intent(activity,CompetityActivity.class);
                        intent.putExtras(bundle);
                        activity.startActivity(intent);
